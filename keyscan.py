...
def main(cert_path, data_path):
  assert(os.path.isfile(cert_path) and os.path.isfile(data_path))
  ...
  with open(data_path, 'rb') as f:
    ...
    print('Data length: %d'%mm_data.size())
    length = mm_data.size() - key_size
